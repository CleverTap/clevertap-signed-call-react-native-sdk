...
import com.clevertap.rnsignedcallandroid.SCBackgroundCallEventHandler;
...
import com.example.rnsignedcall.newarchitecture.MainApplicationReactNativeHost;
  ...
  private static void initializeFlipper(
    ...
    if (BuildConfig.DEBUG) {
      try {
        ...
        */
        Class<?> aClass = Class.forName("com.clevertapsignedcallreactnativeexample.ReactNativeFlipper");
        aClass
